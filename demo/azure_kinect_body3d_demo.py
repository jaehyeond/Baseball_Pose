...
# Modified for Azure Kinect 3D Pose Visualization
import logging
import mimetypes
import os
import time
...
# We don't need mmdet for pre-computed 3D poses
has_mmdet = False


def parse_args():
    parser = ArgumentParser(description='Azure Kinect 3D Pose Visualization')
    parser.add_argument(
        '--input', 
        type=str, 
        default='../azure_kinect_3d_results.json',
